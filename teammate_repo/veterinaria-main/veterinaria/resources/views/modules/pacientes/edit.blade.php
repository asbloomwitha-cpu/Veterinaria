...
<div class="row mb-4 align-items-center" data-aos="fade-right">
    <div class="col-12">
        <h2 style="font-weight: 800; color: #1f2d3d; margin-bottom: 5px; font-size: 1.75rem;">Editar Paciente</h2>
...
<div class="vet-card mb-5" data-aos="fade-up">
    <form action="{{ route('pacientes.update', $paciente->id) }}" method="POST">
        ...
        <div class="mt-4 d-flex flex-column flex-sm-row justify-content-end">
            ...
            <button type="submit" class="btn btn-vetcare order-1 order-sm-2">Actualizar Paciente</button>
        </div>
    </form>
</div>
@endsection
